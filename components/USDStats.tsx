...
export default function USDStats({
    perSecond,
    base,
    annualFederalSpending,
    annualBudgetDeficit,
    initialBtcPrice,
}: USDStatsProps) {
            ...
            <div className="relative z-10 flex flex-col gap-6 w-full h-full justify-center">
                ...
                <div className="grid grid-cols-3 gap-6 w-full">
                    ...
                    <div className="flex flex-col shadow-xl">
                        <div
                            className={`${headerBgColor} flex items-center justify-center ${headerPadding} h-32`}
                        >
                            <h2
                        ...
                        <div
                            className={`flex items-center justify-center flex-1 ${contentBgColor} ${contentPadding}`}
                        >
                            <div
                ...
                <div className="grid grid-cols-2 gap-6 w-full">
                    ...
                    <div className="flex flex-col shadow-xl">
                        <div
                            className={`${headerBgColor} flex items-center justify-center ${headerPadding}`}
                        >
                            <h3
                                className="text-white text-center tracking-wider uppercase"
                                style={headerFont}
                        ...
                        <div
                            className={`flex flex-col items-center justify-center flex-1 ${contentBgColor} ${contentPadding}`}
                        >
                            <div className="text-white tabular-nums text-center" style={valueFont}>
                ...
                <div className="flex flex-col shadow-xl">
                    ...
                    <div
                        className={`flex items-center justify-between px-12 py-6 flex-1 ${contentBgColor}`}
                    >
                        {/* 1960 */}
                ...
                <div className="absolute bottom-2 right-4 z-50 pointer-events-none">
                    <p className="text-white/40 text-[10px] sm:text-xs text-right max-w-2xl leading-tight">
                        Spending and deficit represent official totals for the last completed Fiscal
                        Year from U.S. Treasury Monthly Treasury Statement (FiscalData.gov).
                    </p>
                </div>
            </div>
        </div>
