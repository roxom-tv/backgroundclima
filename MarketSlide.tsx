    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {up ? '▲ +' : '▼ '}
                    {t.chgPct.toFixed(2)}%&nbsp;&nbsp;{up ? '+' : '−'}${Math.abs(t.chg).toFixed(2)}
                </span>
            </div>
            ...
            >
                    ...
                    <div style={{ marginLeft: 40 }}>
                        ...
                        <div
                            style={{
                                ...
                                fontWeight: 700,
                                fontFamily: T.mono,
                                color: t.w52Pos >= 99 ? T.accent : t.w52Pos < 20 ? T.red : T.text,
                            }}
                        >
                ...
                >
                    ...
                    <span
                        style={{ fontSize: 27, fontWeight: 700, fontFamily: T.mono, marginLeft: 5 }}
                    >
                        {t.dayRange}
                    </span>
                </div>
...
export default function MarketSlide() {
    ...
    useEffect(() => {
        ...
        return () => {
            if (stockTimer.current) {
                clearInterval(stockTimer.current);
            }
        };
    }, []);
    ...
    const currentIdx =
        (idxPage === 0 ? idxP1 : idxP2).length > 0
            ? idxPage === 0
                ? idxP1
                : idxP2
            : FALLBACK_INDICES;
...
function LiveDot() {
    return (
        <motion.div
            ...
            animate={{
                boxShadow: [
                    '0 0 0 0 rgba(231,0,11,0.7)',
                    '0 0 0 5px rgba(231,0,11,0)',
                    '0 0 0 0 rgba(231,0,11,0.7)',
                ],
            }}
