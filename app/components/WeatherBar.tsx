        ...
        const fetchWeather = async () => {
            ...
            try {
                ...
                const response = await fetch(
                    `/api/weather?query=${encodeURIComponent(currentSlide.weather_query)}`,
                );
                            ...
                            >
                                {weatherData ? (
                                    <>
                                        ...
                                        <span className="temp-celsius">{weatherData.tempC}°C</span>
                                    </>
                                ) : (
                                    <>
                    ...
                    <div className="weather-section">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                {weatherData ? (
                                    <>
                                        <span className="wind-kmh">{weatherData.windKmh} km/h</span>
