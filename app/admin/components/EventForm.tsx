        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                ...
                <p className="text-xs text-gray-500 mb-3">
                    Add times for different timezones (e.g., &quot;8:00 PM&quot; + &quot;ET&quot;,
                    &quot;5:00 PM&quot; + &quot;Buenos Aires&quot;)
                </p>
            ...
            <div className="border-t-2 border-[#1a1a1a] pt-4">
                ...
                >
                    <span
                        className={`transform transition-transform ${showStyleOptions ? 'rotate-90' : ''}`}
                    >
                        ▶
                    </span>
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            {TEXT_SIZES.map((size) => (
                                <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                        setFormData((prev) => ({ ...prev, title_size: size.value }))
                                    }
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[#888] font-mono uppercase tracking-wider">
                                DISPLAY THE DATE BADGE ON THE EVENT
                            </p>
                        </div>
                    </label>
                    ...
                    <div className="border-t-2 border-[#1a1a1a] pt-4">
                        ...
                        >
                            ...
                            <div
                                ...
                                style={{
                                    backgroundColor: `rgba(0,0,0,${(formData.overlay_opacity ?? 50) / 100})`,
                                }}
                            />
                            {/* Content */}
                            <div className="relative z-10">
                                <h3
                                    ...
                                    style={{
                                        ...
                                        fontSize:
                                            formData.title_size === 'small'
                                                ? '1.25rem'
                                                : formData.title_size === 'medium'
                                                  ? '1.5rem'
                                                  : formData.title_size === 'xlarge'
                                                    ? '2.5rem'
                                                    : '2rem',
                                    }}
                                >
                                ...
                                <p
                                    style={{
                                        color: formData.text_color || '#F3F4F6',
                                        fontSize: '0.875rem',
                                    }}
                                >
            ...
            <div className="bg-[#0a0a0a] p-4 border-2 border-[#00ff00]">
                <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-[#888] font-mono uppercase tracking-wider">
                            SHOW THIS EVENT IN THE CALENDAR
                        </p>
                    </div>
                </label>
            </div>
