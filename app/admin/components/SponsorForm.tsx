...
export default function SponsorForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        {formData.logo_url && (
          <div className="mb-3 p-4 bg-[#0a0a0a] border-2 border-[#00ff00]">
            <p className="text-[#888] text-xs font-mono mb-2 uppercase tracking-wider">CURRENT LOGO:</p>
        ...
        {/* Upload Error */}
        {uploadError && (
          <p className="text-[#ff0000] text-xs font-mono mt-2 uppercase tracking-wider">{uploadError}</p>
        )}
      ...
      {/* Website URL */}
      <div>
        <label htmlFor="website_url" className="block text-xs font-mono font-medium text-white uppercase tracking-wider mb-1">
          WEBSITE URL
        </label>
        <input
          id="website_url"
      ...
      <div>
        <label className="flex items-center gap-3 cursor-pointer">
          ...
          />
          <span className="text-white font-mono text-xs uppercase tracking-wider">ACTIVE (SHOW ON DISPLAY)</span>
        </label>
      </div>
