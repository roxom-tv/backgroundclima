...
export default function SlidePreviewPage() {
    ...
    const renderSlide = () => {
        ...
        switch (slide.type) {
            case 'youtube':
                return (
                    <>
                        <RotatingBackground activeIndex={0} slides={[slide]} currentSlide={slide} />
                        <div className="top-info-bar">
                            <DateDisplay activeIndex={0} timezone={slide.timezone || undefined} />
            ...
            case 'video':
                return (
                    <div
                        ...
                        style={{ position: 'absolute', inset: 0 }}
                    >
                        <VideoSlide slide={slide} onVideoEnd={() => {}} />
                        <div className="absolute bottom-4 right-4 z-20">
                            <SponsorDisplay
                                sponsors={slideSponsor ? [slideSponsor] : sponsors}
                                visible={settings.show_sponsors && (slide.show_sponsor ?? false)}
    ...
    return (
        <div className="h-screen w-screen bg-black overflow-hidden relative">
            ...
            <div className="absolute top-0 left-0 right-0 z-50 bg-[#0a0a0a] border-b-2 border-[#00ff00] px-4 py-2">
                <div className="max-w-[1800px] mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <span className="text-[#00ff00] font-mono text-xs uppercase tracking-wider">
                            PREVIEW MODE
                        </span>
            ...
            {/* Slide Content */}
            <div className="h-full w-full pt-12 relative">{renderSlide()}</div>
        </div>
    );
}
