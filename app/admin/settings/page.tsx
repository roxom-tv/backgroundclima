    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-[#0a0a0a] border-2 border-[#00ff00] divide-y divide-[#1a1a1a]">
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-white font-mono font-medium text-xs uppercase tracking-wider">
                                SHOW SPONSORS
                            </h3>
                            <p className="text-[#888] text-xs font-mono mt-1 uppercase tracking-wider">
                ...
                <div className="p-4">
                    <div>
                        <h3 className="text-white font-mono font-medium text-xs uppercase tracking-wider mb-3">
                            TRANSITION EFFECT
                        </h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {TRANSITION_EFFECTS.map((effect) => (
                                <button
                                    key={effect.value}
                                    onClick={() =>
                                        handleSelectChange('transition_effect', effect.value)
                                    }
                ...
                <div className="p-4">
                    <div>
                        <h3 className="text-white font-mono font-medium text-xs uppercase tracking-wider mb-1">
            ...
            <div className="bg-[#0a0a0a] p-4 border-2 border-[#00ff00] border-l-4">
                <h3 className="text-white font-mono font-medium text-xs uppercase tracking-wider mb-2">
                    ℹ️ ABOUT REAL-TIME UPDATES
                </h3>
                <p className="text-[#888] text-xs font-mono uppercase tracking-wider">
                    CHANGES YOU MAKE HERE WILL BE REFLECTED ON THE DISPLAY IN REAL-TIME. NO NEED TO
                    REFRESH THE DISPLAY PAGE - IT WILL AUTOMATICALLY PICK UP THE NEW SETTINGS.
                </p>
            </div>
        </div>
    );
