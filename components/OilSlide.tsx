                ...
                <div className="flex flex-col shadow-xl">
                    ...
                    >
                        {loading && !hasData && !data ? (
                            ...
                            >
                                <span>
                                    {formatSats(wti.sats).number} <i className="fak fa-regular"></i>
                                </span>
                                <span className="text-white/60">|</span>
                                <span className="text-white whitespace-nowrap">
                                    USD $
                                    {wti.usd.toLocaleString('en-US', {
                                ...
                                {wti.change24hPct !== null && (
                                    <>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span
                                                className={`tabular-nums ${wti.change24hPct >= 0 ? 'text-green-400' : 'text-red-400'}`}
                                                style={changeFont}
                                            >
                ...
                <div className="flex flex-col shadow-xl">
                    ...
                    >
                        {brent && brent.usd > 0 ? (
                            ...
                            >
                                <span>
                                    {formatSats(brent.sats).number}{' '}
                                    <i className="fak fa-regular"></i>
                                </span>
                                <span className="text-white/60">|</span>
                                <span className="text-white whitespace-nowrap">
                                    USD $
                                    {brent.usd.toLocaleString('en-US', {
                                        maximumFractionDigits: 2,
                                        minimumFractionDigits: 2,
                                    })}
                                </span>
                                {brent.change24hPct !== null && (
                                    <>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span
                                                className={`tabular-nums ${brent.change24hPct >= 0 ? 'text-green-400' : 'text-red-400'}`}
                                                style={changeFont}
                                            >
